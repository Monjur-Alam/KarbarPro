...
class AppLocalizations {
  ...
  String get backupRestore =>
      isBangla ? 'ব্যাকআপ ও পুনরুদ্ধার' : 'Backup & Restore';
  ...
  String get logoutConfirmMessage => isBangla
  ...
  String get resetDataConfirmTitle =>
      isBangla ? 'ডাটা রিসেট করুন' : 'Reset Data';
  ...
  String get resetDataSuccess => isBangla
      ? 'সমস্ত ডাটা সফলভাবে রিসেট করা হয়েছে'
  ...
  String get deleteAccountConfirmTitle => isBangla
      ? 'অ্যাকাউন্ট স্থায়ীভাবে মুছবেন?'
      : 'Permanently delete account?';
  String get deleteAccountConfirmMessage => isBangla
      ? 'আপনার সকল বিক্রয়, পণ্য, গ্রাহক, খরচ, সেটিংস এবং গুগল ড্রাইভ ব্যাকআপ মুছে ফেলা হবে। গুগল অ্যাকাউন্ট থেকে অ্যাপটির সংযোগও বিচ্ছিন্ন হবে। এই কাজটি পূর্বাবস্থায় ফেরানো যাবে না।'
      : 'All sales, products, customers, expenses, settings, and Google Drive backups will be deleted. The app will also be disconnected from your Google account. This action cannot be undone.';
  String get deleteAccountButton =>
      isBangla ? 'স্থায়ীভাবে মুছুন' : 'Delete permanently';
  String get deletingAccount =>
      isBangla ? 'অ্যাকাউন্ট মুছে ফেলা হচ্ছে…' : 'Deleting account…';
  ...
  String get sectionRecentSales =>
      isBangla ? 'সাম্প্রতিক বিক্রি' : 'Recent Sales';
  String get sectionLowStock =>
      isBangla ? 'সতর্কতা (স্টক কম)' : 'Low Stock Alert';
  String get errorPrefix => isBangla ? 'ত্রুটি: ' : 'Error: ';
  String get live => isBangla ? 'লাইভ' : 'Live';
  String get shopMainBalance =>
      isBangla ? 'দোকানের মেইন ব্যালেন্স' : 'Shop Main Balance';
  String get totalSalesToday =>
      isBangla ? 'মোট বিক্রি (আজ)' : 'Total Sales (Today)';
  String get totalAmountToday =>
      isBangla ? 'মোট টাকা (আজ)' : 'Total Amount (Today)';
  ...
  String get dueLedgerReport =>
      isBangla ? 'বাকি খাতা রিপোর্ট' : 'Due Ledger Report';
  String get dueSummaryTitle =>
      isBangla ? 'বাকির খাতা সারসংক্ষেপ' : 'Due Ledger Summary';
  ...
  String get remainingToPay =>
      isBangla ? 'বাকি দিতে হবে:' : 'Remaining to pay:';
  String get noRecentSales =>
      isBangla ? 'কোন সাম্প্রতিক বিক্রি নেই' : 'No recent sales';
  ...
  String get loginSubtitle =>
      isBangla ? 'আপনার ব্যবসা, এক অ্যাপেই' : 'Your business, all in one app';
  String get signInWithGoogle =>
      isBangla ? 'গুগল দিয়ে সাইন ইন' : 'Sign in with Google';

  // ——— Profile ———
  String get autoBackup => isBangla ? 'অটো ব্যাকআপ' : 'Auto Backup';
  String get autoBackupSubtitle => isBangla
      ? 'সর্বদা গুগল ড্রাইভে সিঙ্ক থাকে'
      : 'Always synced to Google Drive';
  ...
  String get salesDataLoadError =>
      isBangla ? 'বিক্রয় ডাটা লোড করা যাচ্ছে না' : 'Could not load sales data';
  ...
  String get noSalesData =>
      isBangla ? 'কোনো বিক্রয় তথ্য পাওয়া যায়নি' : 'No sales data found';
  String get unknownProduct => isBangla ? 'অজানা পণ্য' : 'Unknown product';
  String get sortNewestFirst =>
      isBangla ? 'সর্বশেষ থেকে পুরাতন' : 'Newest first';
  String get sortOldestFirst =>
      isBangla ? 'পুরাতন থেকে সর্বশেষ' : 'Oldest first';
  ...
  String get searchInvoiceOrCustomer => isBangla
      ? 'ইনভয়েস বা গ্রাহক খুঁজুন...'
      : 'Search invoice or customer...';
  String get saleSuccess =>
      isBangla ? 'বিক্রয় সফল হয়েছে!' : 'Sale successful!';
  String get totalAmountLabel => isBangla ? 'মোট পরিমাণ:' : 'Total amount:';
  String get invoiceColon => isBangla ? 'ইনভয়েস:' : 'Invoice:';
  String get offlineSalesBanner => isBangla
      ? 'অফলাইন মোডে বিক্রয় - ডেটা পরবর্তীতে সিঙ্ক হবে'
      : 'Offline sales mode - data will sync later';
  String get sortBy => isBangla ? 'সাজান (Sort By)' : 'Sort By';
  String get sortAmountDesc =>
      isBangla ? 'টাকার অঙ্ক (বেশি থেকে কম)' : 'Amount (high to low)';
  String get sortAmountAsc =>
      isBangla ? 'টাকার অঙ্ক (কম থেকে বেশি)' : 'Amount (low to high)';
  String get totalPrefix => isBangla ? 'মোট' : 'Total';

  // ——— Inventory ———
  String get addNewItem => isBangla ? 'নতুন আইটেম যোগ' : 'Add New Item';
  String get searchProducts =>
      isBangla ? 'পণ্য অনুসন্ধান করুন...' : 'Search products...';
  ...
  String get manageCategories =>
      isBangla ? 'ক্যাটাগরি ম্যানেজ করুন' : 'Manage Categories';
  ...
  String get noProductsFound =>
      isBangla ? 'কোনো পণ্য পাওয়া যায়নি' : 'No products found';
  String get addProductHint => isBangla
      ? 'নতুন পণ্য যোগ করতে নিচের বাটনে ক্লিক করুন'
      : 'Tap the button below to add a new product';
  ...
  String get permissionRequired =>
      isBangla ? 'অনুমতি প্রয়োজন' : 'Permission required';
  String get cancel => isBangla ? 'বাতিল' : 'Cancel';
  String get enterItemName =>
      isBangla ? 'আইটেমের নাম লিখুন' : 'Enter item name';
  String get enterSellingPrice =>
      isBangla ? 'বিক্রয় মূল্য লিখুন' : 'Enter selling price';
  String get addProductInstructionsTitle =>
      isBangla ? 'পণ্য যোগ করার নির্দেশনা' : 'How to add a product';
  String get instruction1 => isBangla
      ? 'আইটেমের নাম লিখুন (বাধ্যতামূলক)'
      : 'Enter item name (required)';
  String get instruction2 => isBangla
      ? 'ক্যাটাগরি নির্বাচন করুন (ঐচ্ছিক)'
      : 'Select category (optional)';
  String get instruction3 => isBangla
      ? 'বিক্রয় মূল্য এবং ক্রয় মূল্য লিখুন'
      : 'Enter selling and purchase price';
  String get instruction4 => isBangla
      ? 'প্রাথমিক স্টক পরিমাণ এবং একক লিখুন'
      : 'Enter initial stock and unit';
  String get instruction5 => isBangla
      ? 'প্রয়োজনে আইটেম কোড এবং বিবরণ যোগ করুন'
      : 'Add item code and description if needed';
  String get instruction6 => isBangla
      ? 'ছবি যোগ করতে ক্যামেরা আইকনে ক্লিক করুন'
      : 'Tap camera icon to add image';
  String get instruction7 => isBangla
      ? 'সব তথ্য পূরণ করে "সেভ করুন" বাটনে ক্লিক করুন'
      : 'Fill all fields and tap Save';
  ...
  String get itemCode =>
      isBangla ? 'আইটেম কোড (বারকোড)' : 'Item Code (Barcode)';
  String get itemCodeHint =>
      isBangla ? 'স্বয়ংক্রিয়ভাবে তৈরি হবে' : 'Auto-generated';
  String get productSize => isBangla ? 'সাইজ' : 'Size';
  String get sizeHint => isBangla
      ? 'সাইজ লিখুন (যেমন: S, M, L, ৩৮)'
      : 'Enter size (e.g., S, M, L, 38)';
  ...
  String get addItemImage =>
      isBangla ? 'আইটেমের ছবি যোগ করুন' : 'Add item image';
  String get save => isBangla ? 'সেভ করুন' : 'Save';

  // ——— Sale Form Bottom Sheet ———
  String get newSaleInvoice =>
      isBangla ? 'নতুন বিক্রয় (ইনভয়েস)' : 'New Sale (Invoice)';
  String get selectProduct =>
      isBangla ? 'পণ্য নির্বাচন করুন' : 'Select Product';
  String get selectProductHint =>
      isBangla ? 'পণ্য নির্বাচন করুন...' : 'Select a product...';
  ...
  String get selectCustomerHint =>
      isBangla ? 'গ্রাহক নির্বাচন করুন...' : 'Select a customer...';
  String get cashCollectedQuestion =>
      isBangla ? 'নগদ আদায় হয়েছে?' : 'Cash collected?';
  String get collectedAmount =>
      isBangla ? 'আদায়ের পরিমাণ' : 'Collected Amount';
  String get discount => isBangla ? 'ডিসকাউন্ট' : 'Discount';
  String get discountTaka => isBangla ? 'ডিসকাউন্ট (টাকা)' : 'Discount (Tk)';
  String get additionalNotes =>
      isBangla ? 'অতিরিক্ত নোট (ঐচ্ছিক)' : 'Additional Notes (Optional)';
  ...
  String get completeSale =>
      isBangla ? 'বিক্রয় সম্পন্ন করুন' : 'Complete Sale';
  String get selectCustomerWarning =>
      isBangla ? 'গ্রাহক নির্বাচন করুন!' : 'Please select a customer!';
  String get addNewCustomer =>
      isBangla ? 'নতুন গ্রাহক যোগ করুন' : 'Add New Customer';
  String get nameRequired => isBangla ? 'নাম *' : 'Name *';
  String get phoneRequired => isBangla ? 'ফোন নম্বর *' : 'Phone *';
  String get searchCustomer =>
      isBangla ? 'গ্রাহক খুঁজুন...' : 'Search customer...';
  ...
  String get productNotFound =>
      isBangla ? 'পণ্য পাওয়া যায়নি' : 'Product not found';
  String get cameraPermissionRequired =>
      isBangla ? 'ক্যামেরার অনুমতি প্রয়োজন' : 'Camera permission required';
  String get grantPermission => isBangla ? 'অনুমতি দিন' : 'Grant Permission';
  String cartListCount(String count) =>
      isBangla ? 'কার্ট তালিকা (${count}টি)' : 'Cart ($count items)';
  String stockInfo(String stock, String unit) =>
      isBangla ? 'স্টক: $stock $unit' : 'Stock: $stock $unit';

  // ——— Inventory Sort ———
  String get sortLabel => isBangla ? 'সাজান:' : 'Sort by:';
  String get sortQuantityHighToLow =>
      isBangla ? 'পরিমাণ (বেশি থেকে কম)' : 'Quantity (high to low)';
  String get sortQuantityLowToHigh =>
      isBangla ? 'পরিমাণ (কম থেকে বেশি)' : 'Quantity (low to high)';
  String get sortNameAZ => isBangla ? 'নাম (A-Z)' : 'Name (A-Z)';
  String get sortNameZA => isBangla ? 'নাম (Z-A)' : 'Name (Z-A)';

  // ——— Product Form Bottom Sheet ———
  String get noCategoriesHint => isBangla
      ? 'কোনো ক্যাটাগরি নেই। নতুন ক্যাটাগরি লিখুন।'
      : 'No categories yet. Enter a new one.';
  String get cameraPermissionMessage => isBangla
      ? 'ছবি তুলতে ক্যামেরা অনুমতি প্রয়োজন। সেটিংস থেকে অনুমতি দিন।'
      : 'Camera permission is required. Please grant it from settings.';
  ...
  String get sortByLastTransaction =>
      isBangla ? 'সর্বশেষ লেনদেন' : 'Last transaction';
  String get noPhone => isBangla ? 'ফোন নম্বর নেই' : 'No phone';
  String get cannotDeleteCustomerWithDue => isBangla
      ? 'বাকি পরিশোধ না করে গ্রাহক মুছা যাবে না'
      : 'Cannot delete customer with due balance';
  String get delete => isBangla ? 'মুছুন' : 'Delete';
  String get customerDeleted =>
      isBangla ? 'গ্রাহক মুছে ফেলা হয়েছে' : 'Customer deleted';
  ...
  String get editCustomerInfo =>
      isBangla ? 'গ্রাহক তথ্য পরিবর্তন করুন' : 'Edit customer info';
  String get recordPayment =>
      isBangla ? 'বকেয়া পরিশোধের হিসাব রাখুন' : 'Record payment';
  String get recordPaymentSubtitle => isBangla
      ? 'কাস্টমারের কাছ থেকে টাকা জমা নিন'
      : 'Collect payment from customer';
  String get transactionHistory =>
      isBangla ? 'বাকি লেনদেনের ইতিহাস' : 'Transaction history';
  String get contact => isBangla ? 'যোগাযোগ করুন' : 'Contact';
  String get editCustomer => isBangla ? 'গ্রাহক সম্পাদনা' : 'Edit customer';
  String get customerUpdated =>
      isBangla ? 'গ্রাহক তথ্য আপডেট হয়েছে' : 'Customer updated';
  ...
  String get customerReceivable =>
      isBangla ? 'গ্রাহক (আমি পাবো)' : 'Customer (I will receive)';
  String get supplierPayable =>
      isBangla ? 'সাপ্লায়ার (আমি দিবো)' : 'Supplier (I will pay)';
  String get nameRequiredLabel => isBangla ? 'নাম (আবশ্যক)' : 'Name (Required)';
  String get phoneRequiredLabel =>
      isBangla ? 'ফোন নম্বর (আবশ্যক)' : 'Phone Number (Required)';
  String get addressOptional =>
      isBangla ? 'ঠিকানা (ঐচ্ছিক)' : 'Address (Optional)';
  String get commentOptional =>
      isBangla ? 'মন্তব্য (ঐচ্ছিক)' : 'Comment (Optional)';
  String get namePhoneRequiredError => isBangla
      ? 'নাম এবং ফোন নম্বর প্রয়োজন'
      : 'Name and phone number are required';
  String get customerAdded =>
      isBangla ? 'গ্রাহক যুক্ত হয়েছে' : 'Customer added';
  ...
  String get amountToCollect =>
      isBangla ? 'জমা করা টাকার পরিমাণ' : 'Amount to Collect';
  String get noteOptional => isBangla ? 'নোট (ঐচ্ছিক)' : 'Note (Optional)';
  String get enterCorrectAmount =>
      isBangla ? 'সঠিক পরিমাণ লিখুন' : 'Enter correct amount';
  String get moneyCollectionSuccess =>
      isBangla ? 'টাকা জমা নেওয়া সফল হয়েছে' : 'Money collection successful';
  String get confirm => isBangla ? 'নিশ্চিত করুন' : 'Confirm';
  String get noTransactionHistory =>
      isBangla ? 'কোনো লেনদেনের ইতিহাস নেই' : 'No transaction history';
  String get productPurchaseDue =>
      isBangla ? 'পণ্য ক্রয় (বাকি)' : 'Product Purchase (Due)';
  ...
  String get yourShopDueMessage =>
      isBangla ? 'আপনার দোকানের বাকি' : 'Your shop due';
  String get paymentRequestMessage => isBangla
      ? 'পরিশোধ করার জন্য অনুরোধ করা হলো।'
      : 'Payment request initiated.';
  String get deleteCustomerConfirm => isBangla
      ? 'আপনি কি এই গ্রাহককে মুছে ফেলতে চান?'
  ...
  String get allTransactionsDeletedWarning => isBangla
      ? 'সকল লেনদেন ইতিহাস মুছে যাবে!'
      : 'All transaction history will be deleted!';
  String get sortDueHighToLow =>
      isBangla ? 'বাকি (বেশি থেকে কম)' : 'Due (high to low)';
  String get sortDueLowToHigh =>
      isBangla ? 'বাকি (কম থেকে বেশি)' : 'Due (low to high)';
  ...
  String get selectCategoryHint =>
      isBangla ? 'খাত নির্বাচন করুন' : 'Select Category';
  String get addNewCategoryAction =>
  ...
  String get transactionUpdated =>
      isBangla ? 'লেনদেন আপডেট করা হয়েছে' : 'Transaction updated';
  String get transactionUpdateFailed =>
      isBangla ? 'আপডেট করতে সমস্যা হয়েছে' : 'Transaction update failed';
  String get deleteTransactionConfirmQuestion => isBangla
      ? 'আপনি কি এই লেনদেনটি মুছে ফেলতে চান?'
      : 'Are you sure you want to delete this transaction?';
  String get transactionDeleted =>
      isBangla ? 'লেনদেন মুছে ফেলা হয়েছে' : 'Transaction deleted';
  String get transactionDeleteFailed =>
      isBangla ? 'মুছে ফেলতে সমস্যা হয়েছে' : 'Transaction delete failed';
  ...
  String get depositSuccess =>
      isBangla ? 'সাফল্যের সাথে যোগ করা হয়েছে' : 'Deposit added successfully';
  String get expenseRecorded =>
      isBangla ? 'খরচ রেকর্ড করা হয়েছে' : 'Expense recorded successfully';
  String get noResultsFound =>
      isBangla ? 'কোনো ফলাফল পাওয়া যায়নি' : 'No results found';
  String get noTransactionsRecorded =>
      isBangla ? 'কোনো লেনদেন রেকর্ড করা হয়নি' : 'No transactions recorded';
  ...
  String get showCurrentMonth =>
      isBangla ? 'বর্তমান মাস দেখুন' : 'Show Current Month';
  ...
  String get totalSalesCredit =>
      isBangla ? 'বাকি বিক্রি' : 'Total Sales in Credit';
  String get paidToSupplierLabel =>
      isBangla ? 'সাপ্লায়ারকে পরিশোধ' : 'Paid to Supplier';
  String get dueCollectionLabel => isBangla ? 'বাকি আদায়' : 'Due Collection';
  String get totalReceivableLabel =>
      isBangla ? 'মোট পাওনা' : 'Total Receivable';
  ...
  String get enableTextOnlyPrint =>
      isBangla ? 'টেক্সট অনলি প্রিন্ট চালু করুন' : 'Enable text only print';
  String get textOnlyPrintDesc => isBangla
      ? 'টেক্সট অনলি প্রিন্ট মোড শুধু ইংরেজি ভাষায় প্রিন্ট করতে পারে\nতবে প্রিন্টিং দ্রুত হবে এবং বেশিরভাগ প্রিন্টারে সাপোর্ট করবে'
  ...
  String get sortItemsAlphabetical => isBangla
      ? 'রসিদে আইটেমগুলো বর্ণানুক্রমিক সাজান'
      : 'Sort items alphabetical in receipt';
  String get printCustomerInfoSetting => isBangla
      ? 'রসিদে গ্রাহকের তথ্য প্রিন্ট করুন'
      : 'Print customer info in receipt';
  String get printSalesmanName => isBangla
      ? 'বিলে সেলস ম্যানের নাম প্রিন্ট করুন'
      : 'Print sales man name in bill';
  String get enablePaymentInfoSetting =>
      isBangla ? 'বিলে পেমেন্ট তথ্য চালু করুন' : 'Enable payment info in bill';
  String get enableTableBorder =>
      isBangla ? 'টেবিলের বর্ডার চালু করুন' : 'Enable table border';
  String get enableMinimalInfo => isBangla
      ? 'বিলে সংক্ষিপ্ত তথ্য চালু করুন'
      : 'Enable minimal info in bill';
  String get showTimeOnReceipt =>
      isBangla ? 'রসিদে সময় দেখান' : 'Show time on receipt';
  String get showTaxIncludedPrice => isBangla
      ? 'রসিদ লাইনে ট্যাক্স সহ মূল্য দেখান'
      : 'Show tax included price in receipt lines';
  String get printFontSize =>
      isBangla ? 'প্রিন্ট ফন্ট সাইজ' : 'Print font size';
  String get printLineHeight =>
      isBangla ? 'প্রিন্ট লাইন হাইট' : 'Print line height';
  String get invoiceIdPrefixLbl =>
      isBangla ? 'ইনভয়েস আইডি প্রিফিক্স' : 'INVOICE ID PREFIX';
  String get lastInvoiceIdLbl =>
      isBangla ? 'সর্বশেষ ইনভয়েস আইডি' : 'LAST INVOICE ID';
  String get lastOrderIdLbl =>
      isBangla ? 'সর্বশেষ অর্ডার আইডি' : 'LAST ORDER ID';
  String get customLabelForTaxLbl =>
      isBangla ? 'ট্যাক্সের জন্য কাস্টম লেবেল' : 'CUSTOM LABEL FOR TAX';
  String get customNameForPayableLbl =>
      isBangla ? 'পরিশোধযোগ্য হিসেবে কাস্টম নাম' : 'CUSTOM NAME FOR PAYABLE';
  String get attachQrCodeLbl =>
      isBangla ? 'কিউআর কোড যুক্ত করুন' : 'Attach Qr Code';
  String get enterQrCodeDataLbl =>
      isBangla ? 'কিউআর কোড ডেটা লিখুন' : 'Enter QR code data';
  String get newLineInstructionLbl => isBangla
      ? 'রসিদে নতুন লাইনের জন্য শব্দের মাঝে </br> ব্যবহার করুন'
      : 'Use </br> in between words for new line in receipt';
  String get taxInstructionLbl => isBangla
      ? 'রসিদে প্রিন্ট করার জন্য আপনি ট্যাক্সের কাস্টম নাম সেট করতে পারেন\nযেমন ভ্যাট(৫%), জিএসটি(১৮%) ..ইত্যাদি'
      : 'You can set custom name for Tax that print in receipt\neg VAT(5%), GST(18%) ..etc';
  String get selectedTemplate => isBangla ? 'নির্বাচিত' : 'Selected';
  String get selectThisTemplateBtn =>
      isBangla ? 'এই টেমপ্লেটটি নির্বাচন করুন' : 'Select This Template';
  ...
  String get previewInvoiceDetails =>
      isBangla ? 'চালানের বিবরণ' : 'Invoice Details';
  String get previewOrderId => isBangla ? 'অর্ডার আইডি:' : 'Order ID:';
  String get previewPaymentInfo =>
  ...
  String formatAmount(num value) {
    ...
    return s
        .split('')
        .map((c) => en.contains(c) ? bn[en.indexOf(c)] : c)
        .join();
  }
